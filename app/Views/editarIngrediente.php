    ...
    <body style="background-color: #EDE7B1;">
        <nav class="navbar navbar-light" style="background-color: #5A3A31;">
            <div class="container d-flex justify-content-center">
                <a class="nav-link" href="./index.php"> <img class="navbar-brand" src="../../public/img/logo.png" alt="icon" style="width: 50px;"></a>
            </div>
        </nav>

        <div class="container mt-5">
            <h2>Editar Ingrediente</h2>
            <form action="<?= site_url("salvarEdicaoIngrediente/{$ingrediente['id_ing']}") ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="quantidade" name="quantidade" value="<?= $ingrediente['quantidade'] ?>" required>
                </div>
                <button type="submit" class="btn btn-info">Salvar Alterações</button>
                <a class="btn btn-secondary" href="<?= site_url('ingredientes') ?>">Voltar</a>
            </form>
        </div>
